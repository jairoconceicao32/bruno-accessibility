...
addon_info = AddonInfo(
	...
	addon_name="brunoAccessibility",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Bruno API Client accessibility"),
	# Add-on description
...
"""),
	...
	addon_changelog=_(""""""),
	# Author(s)
	addon_author="Jairo Conceição <jairoconceicao689@gmail.com>",
	# URL for the add-on documentation support
	addon_url="https://github.com/jairoconceicao32/bruno-accessibility",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/jairoconceicao32/bruno-accessibility",
